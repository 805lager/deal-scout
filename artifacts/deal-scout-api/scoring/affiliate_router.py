...
AFFILIATE_PROGRAMS = {
    ...
    "cargurus": {
        ...
        "base_url":     "https://www.cargurus.com/Cars/l-Used",
        "link_format":  "search",
        "network":      "cj",
        "commission":   0.0,
        "cpa_value":    15.0,
    ...
    "rv_trader": {
        "name":         "RV Trader",
        "tag":          os.getenv("RV_TRADER_AFFILIATE_TAG", ""),
        "base_url":     "https://www.rvtrader.com/rvs-for-sale",
        "link_format":  "search",
        "network":      "cj",
        "commission":   0.0,
        "cpa_value":    75.0,
        "categories":   ["rvs", "trailers"],
        "badge_label":  "RV Trader",
        "badge_color":  "#2d6a4f",
        "icon":         "🚐",
        "trusted":      True,
        "status":       "search",
        "notes":        "Largest RV marketplace. CPA via CJ.",
    },

    "camping_world": {
        "name":         "Camping World",
        "tag":          os.getenv("CAMPING_WORLD_AFFILIATE_TAG", ""),
        "base_url":     "https://rv.campingworld.com/rvs-for-sale",
        "link_format":  "search",
        "network":      "awin",
        "commission":   0.03,
        "categories":   ["rvs", "trailers"],
        "badge_label":  "Camping World",
        "badge_color":  "#1a5632",
        "icon":         "🏕️",
        "trusted":      True,
        "status":       "search",
        "notes":        "Largest RV dealer network. Apply via Awin.",
    },

    "boat_trader": {
        "name":         "Boat Trader",
        "tag":          os.getenv("BOAT_TRADER_AFFILIATE_TAG", ""),
        "base_url":     "https://www.boattrader.com/boats-for-sale",
        "link_format":  "search",
        "network":      "cj",
        "commission":   0.0,
        "cpa_value":    50.0,
        "categories":   ["boats"],
        "badge_label":  "Boat Trader",
        "badge_color":  "#1e40af",
        "icon":         "⛵",
        "trusted":      True,
        "status":       "search",
        "notes":        "Largest boat marketplace. CPA model via CJ.",
    },
...
CATEGORY_PROGRAMS = {
    ...
    "rvs":                  ["rv_trader", "camping_world", "ebay"],
    "trailers":             ["rv_trader", "camping_world", "ebay"],
    "boats":                ["boat_trader", "ebay"],
...
def _build_search_link(program_key: str, query: str, tag: str) -> str:
    ...
    param_map = {
        ...
        "rei":         f"?q={encoded}",
        "autotrader":  f"?keyword={encoded}&searchRadius=0&isNewSearch=true&marketExtension=include",
        "cargurus":    f"?keyword={encoded}&searchRadius=50",
        "carmax":      f"?search={encoded}&year=&mileage=&price=",
        "rv_trader":   f"?keyword={encoded}&type=Travel+Trailer%7CClass+A%7CClass+B%7CClass+C%7CFifth+Wheel%7CToy+Hauler&radius=200",
        "camping_world": f"?keyword={encoded}",
        "boat_trader": f"?keyword={encoded}&radius=200",
