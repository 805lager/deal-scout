...
This folder contains the canonical CWS submission copy and assets. Paste fields directly from each file into the dashboard.

| File | CWS dashboard field |
|---|---|
| `title.txt` | Item name |
...
| `screenshots/04_craigslist_speaker.png` | Screenshot 4 |
| `screenshots/05_offerup_ac.png` | Screenshot 5 |
