...
(function () {
  ...
  let API_BASE = "https://deal-scout-production.up.railway.app";
  ...
  function renderFooter(r, container) {
    ...
    footer.innerHTML = `Deal Scout v${VERSION} &middot; <a href="https://deal-scout-production.up.railway.app/docs" target="_blank" rel="noopener" style="color:#6366f1;text-decoration:none">API docs</a>`;
